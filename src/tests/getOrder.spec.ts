...
describe('Tests for getOrder function', () => {
    ...
    it('getOrder returns klarna order', async () => {
        const orderId = 'f3bdd8e3-bd76-6318-ab18-9b6d64de1fef';

        const klarnaOrder: ICreatedKlarnaOrder = await getOrder(
            klarnaSDK,
            orderId,
        );

        expect(klarnaOrder).toStrictEqual({
            order: {
